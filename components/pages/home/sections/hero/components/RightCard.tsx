...
function RightCard() {
  return (
    <div>
      <div className="grid max-w-[90%]  lg:max-w-[70%] xl:max-w-[70%]  mx-auto gap-5">
        <div>
          <h2 className="font-[500] md:text-[30px] lg:text-[35px] xl:text-[43px]   lg:leading-[62px] text-black">
